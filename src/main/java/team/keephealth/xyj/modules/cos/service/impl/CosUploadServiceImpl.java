package team.keephealth.xyj.modules.cos.service.impl;
...
import team.keephealth.common.utils.PathUtils;
...
public class CosUploadServiceImpl implements UploadService {
    ...
    public ResponseResult uploadFile(MultipartFile file) {
        ...
        if (originalFilename.endsWith(".png") || originalFilename.endsWith(".jpg")) {
            filePath = PathUtils.generateImgFilePath(originalFilename);
        } else if (originalFilename.endsWith(".txt")) {
            filePath = PathUtils.generateTxtFilePath(originalFilename);
        } else {
